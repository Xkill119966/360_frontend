  ...
  return (
    <>
      <div className="xl:ml-64 xl:mr-52 lg:ml-24 lg:mr-20 md:ml-16 md:mr-12 sm:ml-4 sm:mr-2 pt-24 text-center">
        <h3 className="my-4 font-bold text-gray-900 dark:text-white xl:text-7xl lg:text-6xl md:text-4xl sm:text-3xl pb-8 font-gordita-bold">
        Thank you for joining us!
        </h3>
        <p className="text-gray my-6 text-center pb-8 font-gordita">We will keep you updated with our launch information</p>
